...
public class MainActivity extends Activity {
    ...
    public void basicNotify(View view) {
        ...
        // 构造PendingIntent，延时Intent，由用户触发
    ...
    public void visibilityNotify(View view) {
        ...
        switch (radioGroup.getCheckedRadioButtonId()) {
            case R.id.radio_button_public:  // 没有锁屏才显示
                builder.setVisibility(Notification.VISIBILITY_PUBLIC);
                builder.setContentText("Public");
                builder.setSmallIcon(R.drawable.ic_public);
                break;
            case R.id.radio_button_private: // 任何情况都显示
                builder.setVisibility(Notification.VISIBILITY_PRIVATE);
                builder.setContentText("Private");
                builder.setSmallIcon(R.drawable.ic_private);
                break;
            case R.id.radio_button_secret:  // 安全锁没有锁屏才显示
